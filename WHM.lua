...
--------------------------------------------------------------------------------------------------------------
include('WHM_Lib.lua')          -- leave this as is    
...
function get_sets()
    ...
    sets.buff['Afflatus Solace'] = {back="Alaunus's cape"}
    ...
    sets.precast["Divine Veil"] = {head="Orison Cap +1"}	 
    ...
    sets.midcast["Divine Veil"] = {head="Orison Cap +1"}
