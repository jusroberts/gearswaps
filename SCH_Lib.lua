...
spell_maps = {
    ...
    ['Pyrohelix']='Helix',['Cryohelix']='Helix',['Anemohelix']='Helix',['Geohelix']='Helix',['Ionohelix']='Helix',['Hydrohelix']='Helix',['Luminohelix']='Helix',['Noctohelix']='DarkHelix',['Kaustra']='DarkHelix',
...
\cs(255, 64, 64)${key_bind_sc_level} \cs(200, 200, 200)Skillchain:\cr ${sc_element_color|\\cs(0, 204, 204)}${toggle_sc_level|Induration} \cr
\cs(255, 64, 64)${key_bind_rem_stratagems} \cs(200, 200, 200)Stratagems:\cr \cs(200, 0, 0)${remaining_stratagems|0}
...
keybinds_off['key_bind_rem_stratagems'] = '       '
...
function validateTextInformation()
    ...
    main_text_hub.remaining_stratagems = get_available_stratagem_count()
...
function get_available_stratagem_count()
    local strat_charge_time = {[1]=240,[2]=120,[3]=80,[4]=60,[5]=33}
