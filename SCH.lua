...
function get_sets()
    ...
    -- Ebulience set empty now as we get better damage out of a good Merlinic head
    sets.buff['Ebullience'] = {
        head="Arbatel Bonnet +1"
    } -- I left it there still if it becomes needed so the SCH.lua file won't need modification should you want to use this set
   
	
    sets.buff['Immanence'] = {
        main="Malice Masher +1",
        sub=empty,
        ring1=empty,
        ring2=empty,
        ear1=empty,
    ...
    sets.midcast["Cursna"] = set_combine(sets.midcast.enhancing, {
        ring2="Ephedra Ring",
